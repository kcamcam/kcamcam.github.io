            ...
            function() {
                var a = !1,
                    ...
                    m = function(a) {
                        ...
                        f && P && gg(E);
                        if (f && z) {
                            var L = C("phone_conversion_number"),
                                F = C("phone_conversion_callback"),
                                K = C("phone_conversion_css_class"),
                                M = C("phone_conversion_options");
                            k(b, L, F || K, M)
                        }
                        var ia = !1 === C("aw_remarketing") || !1 === C("send_page_view");
                        if (!f || !z && !ia)
                            if (!0 === C("aw_remarketing_only") && (z = !1), !1 !== C("allow_ad_personalization_signals") || z) {
                                var J = {
                ...
                (function(a) {
                    ...
                    if (a.vtp_isAutoTag) {
                        ...
                        var q = a.vtp_settings,
                            r = q.eventParameters,
                            u = q.userProperties,
                            t = U(a.vtp_eventParameters,
                                "name", "value");
                        za(t, r);
                        var z = U(a.vtp_userProperties, "name", "value");
                        za(z, u);
                        r.user_properties = u;
                        var I = String(q.streamId),
                            H = String(a.vtp_eventName);
                        Pg(I);
                        Ag(I, H, r);
                        Bg(I)
                    }
            ...
            function() {
                ...
                function c(a, b, c) {
                    ...
                    if (h) {
                        ...
                        if ("gtag.config" === mc) l && (gg(m), zf(m, void 0, void 0)), D(e);
                        else {
                            var n = {},
            ...
            function() {
                var a, b = {
                    ...
                    m = function(a, e, f) {
                        ...
                        if (ya(J))
                            for (var R in J)
                                if (J.hasOwnProperty(R) && /^(dimension|metric)\d+$/.test(R)) {
                                    var S = sg(J[R], a);
                                    void 0 !== S && l(m, R, S)
                                }
                    ...
                    r = function(b) {
                        ...
                        var F = function(a, b, c) {
                            ...
                            K = mc;
                        "page_view" == K ? (u(), p("send", "pageview", E.P)) : "gtag.config" == K ? (u(), 0 != E.sendPageView && p("send", "pageview", E.P)) : "screen_view" == K ? p("send", "screenview", E.P) : "timing_complete" == K ? (F("timingCategory", E.eventCategory, !0), F("timingVar", E.name, !0), F("timingValue", vc(E.value)), void 0 !== E.eventLabel && F("timingLabel", E.eventLabel, !0), p("send", "timing", E.P)) : "exception" == K ? p("send", "exception", E.P) : (0 <= Je("view_item_list select_content view_item add_to_cart remove_from_cart begin_checkout set_checkout_option purchase refund view_promotion checkout_progress".split(" "), K) && (p("require", "ec", "ec.js"), r()), F("eventCategory", E.eventCategory, !0), F("eventAction", E.eventAction || K, !0), void 0 !== E.eventLabel && F("eventLabel",
