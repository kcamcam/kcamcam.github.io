var bajson = {
	"classifiedz":{
		...
		"description":
			"Classifiedz.xyz is a term project for the Software Process class "+
			"at Concordia. We created a classifiedz website to buy and sell "+
			"goods and services, similar to Kijiji.  We were a team of 8 "+
			"people, of which I was the lead. We used Laravel, MySQL, and "+
			"Boostrap.",
	...
	"exambank":{
		...
		"subtitle":"Exam Bank 📝",
		"description":
			"Exam bank is a single comprehensive collection of all the exams I "+
			"have collected throughout the course of my Software Engineering "+
			"Degree at Concordia. A JS script genreates just about the entire "+
			"page added to the repository on GitHub. The website attracts about "+
	...
	"quotifier":{
		...
		"subtitle":"Quotifier 📝",
		"description":
			"Quotifier is a PHP app that adds random quotes by randon authors "+
			"to your code. Give it a try!",
	...
	"clock":{
		...
		"description":
			"Binary clock, a fun little project that makes it easy to read a binary clock.",
	...
	"converter":{
		...
		"description":
			"A simple and elegant converter to convert binary,octal,hex or "+
			"decimal interchangeably.",
	...
	"ppa":{
		...
		"subtitle":"PPA 💪",
		"description":
			"Pro Performance Athletik - Vanilla HTML,CSS,JS and Bootstrap "+
	...
	"cpi":{
		...
		"subtitle":"CPI 💆",
		"description":
			"Clinique Physio Impact - Vanilla HTML,CSS,JS and Bootstrap "+
		"website for a physio/osteopath.",
	...
	"minicalc":{
		...
		"subtitle":"miniCalc ⌚️",
		"description":
			"Website for an apple watch calculator app developed by my "+
			"coleagues <a href=\"https://famingolabs.com\">@Famingo Labs</a>.",
	...
	"cena":{
		...
		"description":
			"Bet you can't see him 🚫. Troll your friends 💩.",
	...
	"trippy":{
		...
		"subtitle":"Trippy ✈️",
		"description":
			"Angel Hacks 2016 - My first ever hackathon, we built a social media "+
			"travel suggestion chat bot using Facebook and Expedia's API.",
	...
	"storyflow":{
		...
		"subtitle":"Story Flow 📸",
		"description":
			"ConUHAcks II - Top 5 out of 600 student. A collaborative Instagram "+
			"stories app. You can think of it kind of like Snapchat stories but "+
			"for Instagram but you get to chose who's in your story.",
	...
	"emojify":{
		...
		"subtitle":"Emojify 🤯",
		"description":
			"Emojify your text! Some pretty sweet JS adds emojis to text anywhere.",
	...
	"kitty":{
		...
		"description":
			"A browser wallpaper that helps keep your 😽 occipied, while you stay busy 🧐.",
	...
	"driverrank":{
		...
		"description":
			"My first rails project. A place where you can rate 💩 "+
			"head drivers on their driving.",
	...
	"famingo":{
		...
		"description":
			"🥇 First place out of 600+ students. <a href=\"https://famingolabs.com\">"+
			"Famingolabs</a> brings you an IOT hardward hack DIY cocktail recipe mixer. "+
			"Built with components from a CNC machine and whatever parts four SOEN"+
			"students turned plumbers for a day could find.",
	...
	"metro":{
		...
		"description":
			"A cheat sheet that tells you exactly which metro cart doors "+ 
			"will land you directly in front of the exit stairs, every time.",
	...
	"readings":{
		...
		"description":
			"I was tired of in class readings that were scanned from books and "+
			"almost impossible to read. ENGR 392 was a reading intensive course, so I "+
		"passed all the readings through the Google Docs OCR to make them reader "+
		"friendly and they can take advantage of safari's reader view.",
	...
	"onesocial":{
		...
		"description":
			"The only social media link you'll ever need to share. "+
			"All of your social media, now all in one place.",
	...
	"twitter":{
		...
		"description":
			"Ask a neural network 🧠 trained with 4783 tweets written in javascript 😲, "+
			"<a href=\"https://github.com/BrainJS/brain.js\">Brain.JS</a>, to "+
			"recognize if the author of a tweet was 🇺🇸 <a href=\"https:\/\/twitter.com\/realDonaldTrump\">"+
			"@realDonaldTrump</a> or 🇨🇦 <a href=\"https:\/\/twitter.com\/JustinTrudeau\">@JustinTrudeau</a>.",
